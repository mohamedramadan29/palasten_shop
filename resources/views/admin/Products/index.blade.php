                                ...
                                <table id="table-search" class="table table-bordered gridjs-table align-middle mb-0 table-hover table-centered">
                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td> {{$product['price']}} </td>
                                            <td>
                                                <img class="img-thumbnail" src="{{asset('assets/uploads/products/'.$product['image'])}}" width="80" height="80px" alt="">
                                            </td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{url('admin/brand/update/'.$product['id'])}}" class="btn btn-soft-primary btn-sm">
