                    ...
                    <div class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <p class="top-bar-text fw-5"> خصم علي المنتجات <a href="shop-default.html"
                                                                                  title="all collection"
                                                                                  class="tf-btn btn-line"> تسوق الان <i
                                            class="icon icon-arrow1-top-left"></i></a></p>
                            </div>
                            <div class="swiper-slide">
                                <p class="top-bar-text fw-5"> العرض الاول في المتجر </p>
                            </div>
                            <div class="swiper-slide">
                                <p class="top-bar-text fw-5"> العرض الثاني في المتجر </p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="top_navbar">
        <div class="sections">
            <div class="logo_section">
                <img src="{{asset('assets/front/images/amazon.png')}}" alt="logo">
            </div>
                ...
                <form method="get" action="">
                    ...
                    <div class="search">
                        <select class="">
                            ...
                            <option value=""> ملابس</option>
                            <option value=""> احذية</option>
                        </select><input class="search_input" type="text" placeholder="اكتب كلمة البحث">
                        <button
